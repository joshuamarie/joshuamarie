...
share:
  ...
  description: "Ways to load / attach packages in R"
  twitter: true
  facebook: true
  reddit: true
  stumble: true
...
| Rank | Method                                      | Verdict                                      |
|------|---------------------------------------------|----------------------------------------------|
| 9    | [`require()`](#require)                     | War criminal                                 |
| 8    | [`library()`](#library-classic)             | Boomer energy                                |
| 7    | [`{pacman}`](#pacman)                       | Convenience trap                             |
| 6    | [`base::use()`](#base-use)                  | Experimental copium                          |
| 5    | [`library() + conflicted`](#combo-pack)     | Manual gearbox                               |
...
1.  Attached the names? Nah, even better: 
    ...
    -  Imports the entire `{dplyr}` package as an *object*.  
    -  Nothing goes into the search path.  
    -  You use it as `dplyr$map()`, `purrr$keep()`, etc.  
...
1.  https://cran.r-project.org/web/packages/box/index.html
2.  https://joshuamarie.github.io/modules-in-r/
